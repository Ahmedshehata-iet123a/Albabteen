...
class InsFinancialReport(models.TransientModel):
    ...
    def action_xlsx(self):
        ...
        sheet.merge_range(0, 0, 2, 2, self.env.user.company_id.name, format_title)
        sheet.insert_image(0, 2, "image.png", {'image_data': product_image, 'x_scale': 0.125, 'y_scale': 0.0625})
        row_pos_2 += 1
        row_pos += 1
