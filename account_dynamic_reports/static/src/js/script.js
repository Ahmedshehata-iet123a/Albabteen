...
var branches_ids = [];
var branches_list = $(".analytic-multiple").select2('data')
for (var i=0; i < branches_list.length; i++){
branches_ids.push(parseInt(branches_list[i].id))
}
domains.branches_ids = branches_ids
//var analytic_ids = [];
...
output.branches_ids = branches_ids
